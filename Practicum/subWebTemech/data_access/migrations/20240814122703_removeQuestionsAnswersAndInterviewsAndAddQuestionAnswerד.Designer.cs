...
namespace subWebTemech.data_access.migrations
{
    ...
    [Migration("20240814122703_removeQuestionsAnswersAndInterviewsAndAddQuestionAnswerד")]
    partial class removeQuestionsAnswersAndInterviewsAndAddQuestionAnswerד
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("subWebTemech.Models.CV", b =>
                {
                    ...
                    b.Property<int>("TransCVLanguageId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("subWebTemech.Models.QuestionAnswer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("subWebTemech.Models.CV", b =>
                {
                    b.HasOne("subWebTemech.Models.Language", "TransCV")
                        .WithMany()
                        .HasForeignKey("TransCVLanguageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("subWebTemech.Models.QuestionAnswer", b =>
                {
                    b.HasOne("subWebTemech.Models.AnswerSimulation", "AnswerSimulation")
                        .WithMany()
                        .HasForeignKey("AnswerSimulationID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
